...
#' frame of atomic predictions. It does not calculate an estimate of
#' ELPD, rather N*ELPD, where N is the bumber of observations, so that 
#' the weights scale with weight of evidence.
#' 
